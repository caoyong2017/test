    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            <header id="topbar">
                ...
                <button type="button" class="btn btn-sm btn-dark " style="margin-left: 15px" id="addReg">查询报表</button>
                </div>
            </header>
            <!-- End: Topbar -->
            <!-- Begin: Content -->
                        ...
                        <div class="panel panel-visible">
                            <div class="panel-heading br-b-n">
                                <div class="panel-title hidden-xs">
                                    <span class="glyphicon glyphicon-tasks"></span>DCT300</div>
                            </div>
                            <div class="panel-body pn">
                     <!--            <div >
                  <iframe id="reportFrame1" width="900" height="400" src="http://localhost:8080/lg/ReportServer?reportlet=/getrag_EP_qualtiy_dct300_sheet.cpt"></iframe>
                 </div> -->
                   <div >
                  <iframe id="reportFrame1" width="900" height="400" src="http://localhost:8080/fineWeb/ReportServer?reportlet=/test1.cpt"></iframe>
                 </div>
                            </div>
                        </div>
                    </div>
